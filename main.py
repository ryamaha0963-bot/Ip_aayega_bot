"""
Simple IP Grabber Bot - Single File
Bas 2 files mein kaam khatam!
"""
...
if not all([API_ID, API_HASH, BOT_TOKEN, ADMIN_ID]):
    ...
    LOGGER.info("Required: API_ID, API_HASH, BOT_TOKEN, ADMIN_ID")
    sys.exit(1)
...
class IPExtractor:
    ...
    async def extract(self, chat_id: int) -> Tuple[Optional[str], Optional[int]]:
        """Extract IP and port from voice chat"""
        try:
            # Resolve peer
